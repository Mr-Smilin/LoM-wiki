...
<BTable :stickyHeader=true :unsearch=true>
  ...
  <tr>
    ...
    <td>曾留學青城，於<MarkdownWrapper>[唐門內戰](/event/simple/2-12-3-唐門內戰)</MarkdownWrapper>捕獲唐守鴻後，<MarkdownWrapper>[唐守鴻處置](/event/simple/2-12-3-唐守鴻處置)</MarkdownWrapper>時獲得配方，煉丹房開發</td>
    <td></td>
  </tr>
  <tr>
    <td>靈丹</td>

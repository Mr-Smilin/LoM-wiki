  ...
  <tr>
    ...
    <td rowspan=8>
        <li>
            ...
            且大會中途未離開唐門<br>
            (即趙活未挑戰上官隼，<br>
            且🚩<MarkdownWrapper>[葉雲舟代表唐門出戰](/event/simple/3-10-2-點蒼逆徒)</MarkdownWrapper>)。<br>
            大會後<MarkdownWrapper>[客棧休憩](/event/simple/3-10-2-客棧休憩)</MarkdownWrapper>時，<br>
            先洗澡，再下樓喝酒，<br>
            以觸發<MarkdownWrapper>[南溪夜訪](/event/simple/3-10-2-南溪夜訪)</MarkdownWrapper>事件，<br>
            葉雲舟好感≥40獲得。<br>
        </li>
    </td>
    <td rowspan=8></td>
...
<table>
  ...
  <tr>
    ...
    <td style="text-align: center">-</td>
    <td style="text-align: center">-</td>
    <td style="text-align: center">一種</td>
    <td style="text-align: center">一種</td>
    <td style="text-align: center">一種</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="text-align: center">一種</td>
    <td style="text-align: center">一種</td>
    <td style="text-align: center">兩種</td>
    <td style="text-align: center">兩種</td>
    <td style="text-align: center">兩種</td>
    <td style="text-align: center">兩種</td>
    <td style="text-align: center">兩種</td>

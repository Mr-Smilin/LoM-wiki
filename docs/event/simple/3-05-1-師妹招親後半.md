...
擁有《很是用力踢》：獲得秘笈《蛇兔鷹猿搏》
	...
	<tr>
		<td>-</td>
		<td>
            若符合以下條件，設置🚩「雲裳結緣前置」:<br>
            • <Girl2Icon>葉雲裳</Girl2Icon>在唐門(需<MarkdownWrapper>[留學青城](/event/simple/2-08-2-唐門迎敵)</MarkdownWrapper>且<MarkdownWrapper>[葉氏兄妹未離去](/event/simple/3-01-1-葉氏兄妹離去)</MarkdownWrapper>)<br>
            • 葉雲裳未死亡(目前應無在此之前死亡情況)<br>
            • 葉雲裳好感≥50<br>
            <br>
			👉選擇：招親武試 <br>
			「倒頭大睡」 → ☯事件：招親晚宴；若有🚩雲裳結緣前置，則接<MarkdownWrapper>[「雲裳結緣」](/event/simple/3-05-1-雲裳結緣)</MarkdownWrapper>。 <br>
...
心上人唐默鈴：向心+1
			...
			<br>
            若有🚩雲裳結緣前置，此時接<MarkdownWrapper>[「雲裳結緣」](/event/simple/3-05-1-雲裳結緣)</MarkdownWrapper>。<br>
            <br>

...
<script>
    ...
    const I18N = {
        disclaimer: {
            ...
            "zh-cn": "注：本图片生成器仅供推广 活侠传 (Legend of Mortal) 使用，<br>请勿用于商业用途。",
        ...
        mobileNote: {
            ...
            "zh-cn": "部分浏览器与移动设备若无法直接下载，将改用「分享」方式保存图片。",
        ...
        btnGenerate: { zh: "產生圖片", "zh-cn": "生成图片", en: "Generate Image", ja: "画像を生成" },
        btnClear: { zh: "清除全部資料", "zh-cn": "清除全部数据", en: "Clear All", ja: "すべてクリア" },
        btnExample: { zh: "帶入範本", "zh-cn": "载入模板", en: "Load Example", ja: "サンプルを読み込む" },
        titleLabel: { zh: "請在這裡輸入標題：", "zh-cn": "请在这里输入标题：", en: "Enter a title here:", ja: "タイトルを入力：" },
        contentLabel: { zh: "請在這裡輸入內容：", "zh-cn": "请在这里输入内容：", en: "Enter the content here:", ja: "内容を入力：" },
        contentPlaceholder: { zh: "請在此輸入內容", "zh-cn": "请在此输入内容", en: "Enter content here", ja: "内容を入力してください" },
        autoBreak: { zh: "內容自動換行", "zh-cn": "内容自动换行", en: "Auto line break", ja: "自動改行" },
        tagReplace: { zh: "<br>、</br>自動取代", "zh-cn": "<br>、</br>自动替换", en: "Auto-replace <br> tags", ja: "<br>タグを自動置換" },
        uploadLabel: { zh: "請點選匯入圖片:", "zh-cn": "请点击导入图片:", en: "Choose an image to import:", ja: "画像を選択：" },
        sizeHint: {
            zh: "建議使用尺寸為 480 * 700 的圖片。",
            "zh-cn": "建议使用尺寸为 480 * 700 的图片。",
            en: "Recommended size: 480 × 700.",
            ja: "推奨サイズ：480 × 700。"
        },
        formatHint: {
            zh: "建議使用 PNG 格式的圖片, 透明背景的圖片效果會更好。",
            "zh-cn": "建议使用 PNG 格式的图片, 透明背景的图片效果会更好。",
        ...
        exampleContext: {
            ...
            "zh-cn": "终于轮你当主角，你的谢幕可歌可泣，世上无人再敢看轻你。",
    ...
    export default {
        ...
        computed: {
            ...
            t() {
                const l = (this.localeIndex === "en" || this.localeIndex === "ja" || this.localeIndex === "zh-cn") ? this.localeIndex : "zh";
                const out = {};

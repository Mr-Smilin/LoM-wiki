---
title: 風雲史 (実績)
description: 全ての実績（成就）に関連する情報を記載します。
aside: false
outline: [2, 3]
sidebar: false
borderless: true
...
<BTable>
    <tr>
        <td>番号</td>
        <td :unsortable="true">実績</td>
        <td :unsortable="true">実績説明</td>
        <td :unsortable="true">解除条件</td>
        <td :unsortable="true">解除特性</td>
    ...
    <tr>
        ...
        <td>
            第一段階: 臥雲崗 (飛俠落地) イベントで金烏の死んだふりを発生させる:<br>
            1. 唐布衣と一緒に山を下りた場合: 金烏上人と遭遇した後、対決の結果が「小梅に敗北」以外であること。<br>
            2. 唐布衣と山を下りない場合: <Girl3Icon>小梅</Girl3Icon>が唐門におらず、唐布衣を治療し、襲撃された時に「収功」を選び、その後の戦闘で金烏上人に勝つこと。<br>
            <br>
            第二段階: <Girl0Icon>唐默鈴</Girl0Icon>の比武招親イベントで金烏上人を打ち倒す<br>
        </td>
        <td></td>
        <td></td>
    </tr>
    ...
    <tr>
        ...
        <td>臥雲崗イベントで山を下りることを選び、帰路で金烏上人と対戦。戦闘に敗北するか、勝利後に【＜70 食らう】になって金烏に殴られて気絶する時に自動取得。</td>
        <td></td>
        <td></td>
    </tr>
    <tr>
        ...
        <td>
            錦香宮での滞在の終盤、<MarkdownWrapper>[温夫人の付託](/ja/event/simple/3-10-2-溫夫人託付#託付宮人)</MarkdownWrapper>の際、温夫人の問答2問目で👉「支離滅裂だ」を選ばないこと。その上で錦香宮好感≥5を満たし、天命の擲骰で温夫人に引き止めさせる:<br>
            • 骰子🎲の上限50、道徳・性情で補正、処世は減算<br>
            • 錦香宮好感=5または6の場合: 【🎲≥80 少侠、お待ちを】が必要<br>
            • 錦香宮好感≥7の場合: 【🎲≥50 少侠、お待ちを】が必要<br>
        </td>
        <td></td>
        <td></td>
    </tr>
    <tr>
        ...
        <td>
            方法1. ゲーム開始時の鏡を見るイベントで「悪くもない」を選択<br>
            方法2. 心変わりの夢で「知らない人」を選ぶ。
        </td>
        <td></td>
        <td>残念ながらバッドエンドでは常に~~誰からも愛されていない~~と書かれている</td>
    </tr>
    <tr>
        ...
        <td>心変わりの夢を一度も見ていない、または心変わりの夢で毎回同じ人を選ぶ。<br>
        </td>
        <td></td>
        <td>~~選択肢を誤クリックしないことを切に願う。~~</td>
    </tr>
    <tr>
        ...
        <td>
            ...
            かつ3年目の10月、武林盟主イベントで自分が盟主になることを選ぶ。
        </td>
        <td></td>
        <td></td>
    </tr>
    <tr>
        ...
        <td>2年目に留学を選ばず宿屋に泊まり、<br>
            千面人魔と龍淵のイベントで「俺はお前ら二人をぶっ潰す」を選んだ後に取得。</td>
        <td></td>
        <td>~~君のような要求は、この世で見たことがない。~~</td>
    </tr>
    <tr>

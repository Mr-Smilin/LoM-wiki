...
<td>• <MarkdownWrapper>[廃寺の密謀](/ja/event/simple/2-08-2-破廟密謀)</MarkdownWrapper>事件で📜「唐門を攻撃する」や📜「逃げる」を選んではいけない。
    <br>• <MarkdownWrapper>[唐門の迎撃](/ja/event/simple/2-08-2-唐門迎敵)</MarkdownWrapper>事件で🚩山道を離れてはいけない(離脱できるのは大門を選んだ場合のみ)。
...
<td>• まず想い人が<Girl2Icon>葉雲裳</Girl2Icon>、葉雲裳好感≧50、秘笈<MarkdownWrapper>[九転残篇](/ja/system/books/book_8109)</MarkdownWrapper>の修練完了を確認。
    ...
    <br>• 異種真気(幻境の対戦相手)との戦闘はすべて勝利する必要があり、これで結縁過程に進む。
    <br>• このイベントを完了し道具<MarkdownWrapper>[【葉雲裳の櫛】](/ja/people/characters/girl2.html#結縁信物)</MarkdownWrapper>を入手すると、結縁完了。
</td>
<td>• <Girl2Icon>葉雲裳</Girl2Icon>好感を稼ぎたい場合、後山での修練で焼き魚イベントを狙うとよい。
    <br>• 剣聖の伝承の必要条件: 内力比べで🎲【<99】「一歩及ばない」を出し、かつ<MarkdownWrapper>[谷底での生活](/ja/event/simple/3-05-1-谷底生活)</MarkdownWrapper>で雑談📜「葉雲裳の武功」を選ぶこと。
...
<td>1</td>
<td>3年目7月下旬</td>
<td><MarkdownWrapper>[兄妹対決](/ja/event/simple/3-07-3-兄妹對決)</MarkdownWrapper></td>
...
<td>• 葉雲舟が同行する場合:
    ...
    <br>1. 道中イベント: 展開が変化する。
    <br>2. 錦香宮: 展開が変化する。
    <br>3. 錦香宮: 華音閣で葉雲裳が琴を習うイベントが追加され、3回終えると🚩「葉雲裳、琴を習う」が立つ。これにより西武林ルートの📖「三師兄を護衛する」で雲裳の琴による支援を得られるため、発生させることを推奨する。
</td>
...
<td>伴侶の約束</td>
<td>女弟子房に行くと<Girl2Icon>葉雲裳</Girl2Icon>と自作の紙札遊戯で遊ぶイベントが発生する。</td>
...
<td>葉雲舟も参戦するが、これは必ずしも葉雲裳との結縁を必要とするわけではない。</td>
</tr>

<tr>
<td>10</td>
<td>4年目2月下旬</td>
<td><MarkdownWrapper>[剣聖の伝承](/ja/event/simple/4-02-3-劍聖傳承)</MarkdownWrapper></td>

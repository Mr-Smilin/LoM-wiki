...
<ChTabs position="bottom">
	<ChTab title="顔疆">
		...
		<ChName nameZh='顔疆' nameEn='Yan Jiang' position='right' />
		<ChTable>
			<ChTr>
				<ChTd isTitle=true>
					性別
			...
			<ChTr>
				<ChTd position='center'>
					[金烏上人](/ja/people/characters/special207) (師兄)
				</ChTd>
			</ChTr>
			<ChTr>
				<ChTd position='center'>
					[丹霞子](/ja/people/characters/special404) (師兄)
				</ChTd>
			</ChTr>
			<ChTr>
				<ChTd position='center'>
					[虞小梅](/ja/people/characters/girl3) (師妹)
				</ChTd>
			</ChTr>
		</ChTable>
	</ChTab>

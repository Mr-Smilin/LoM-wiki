...
想い人変更イベント–未知の対象を選ぶ条件</td>
    ...
    <tr>
        <td>南宮護心訣</td>
        <td>1~3</td>
        <td>致命的な攻撃を防ぐことができます(血量が0になる時に10血を回復)。等級に応じて気力を20～40回復します。
            <br>大師兄に内功を伝えた時、「29の内功」「54の内功」「南宮護心訣LV3」が必要です。
（2項目のうち1項目をクリアすれば、クロージングの計算が1項目少なくなります）</td>
        <td>《南宮心法》</td>
    </tr>    
    <tr>
        <td>偕老の誓い</td>
    ...
    <tr>
        ...
        <td>-</td>
        <td>初期気力をさらに増加</td>
        <td>小師妹線選択肢。比武招親当日に追いかけることを選択。
<br>無薬可救の故事(デモ線)で、石幫主にプレゼントを送った後、喧嘩を選択</td>
    </tr>
    <tr>
        <td>決戦唐布衣</td>
        <td>-</td>
...
<br>龍湘があなたの攻撃を受けたり怒った後、この技能は消えます</td>
    ...
    <tr>
        <td>追加暗器</td>
        <td>-</td>
        <td>刺す・暗器に追加暗器を追加（カウントダウン3T）</td>
        <td>《唐門暗器総綱》LV10</td>
    </tr>
    <tr>
        <td>毒功</td>
        <td>-</td>
        <td>刺す時に毒・麻蓄積値を50%附帯</td>
        <td>《五毒密録》LV10</td>
    </tr>
    <tr>
        <td>無影爪</td>
...
<br>龍湘拜堂イベント（※龍湘の想い人専属イベント）で「湘姉、俺が君の仇をとってやる」を選択。勝利または一定回合数の経過で獲得。</td>
    ...
    <tr>
        ...
        <td>破廟線青城療傷時に青城弟子がひっくり返した食べ物をキャッチして習得。
        <br>《拈花指法》は、デモ線(無薬可救の故事)で獲得可能で、メイン線に戻った後、技能と秘笈は消えます。
<br>以下のNPCがこの能力を持つことが知られている：東西武林盟大院保衛戦中の唐衫、滅門線万里鵬程（他にも）。</td>
    </tr>
    <tr>
        <td>逐浪訣</td>
        <td></td>
    ...
    <tr>
        <td>鐵琵琶功</td>
        <td>1~4</td>
        <td>構えで相手の刺すをブロック時、相手の気を削減
<br>境界二以上、刺すで相手の気を削減可能
...
<br>追加で毒・麻蓄積値を代謝
<br>劇情分岐に影響</td>
        <td>▲秘笈《五毒密録》《溫陽活血符》《備急千金要方》《傷寒雜病論》《太平聖惠方》《南宮武備論》《唐門藥典》《八仙指》《難經》
...
<br>境界三以上、我方刀剣+30%・敵方刀剣-30%。刀剣の落差に基づいて招架機率を上昇。</td>
        <td>なし。滅門線終戦瑞笙で、補助者点蒼双尊技能</td>
    </tr>
    <tr>
        <td>蛮勇</td>
        <td></td>
        <td>刺すが暗器に中断されない。ただし受けるダメージ+50%（刺すが暗器と対面する時のみ）
<br>勇猛果敢を獲得しない</td>
    ...
    <tr>
        <td>勇猛果敢</td>
        <td></td>
        <td>性情が蛮勇・勇敢の時限定。刺すが暗器に阻止されない</td>
        <td>暗器に命中した後に発動</td>
    </tr>
    <tr>
        <td>暗器警戒</td>
...
<br>劇情に影響: 江陵包囲前に戦術1以上がある場合《蛇兔鷹猿搏》が取得できない<br>雪山で第三香と戦った後、夏侯蘭が趙活について褒める内容<br>戦術5以上がない場合は西武林盟を自分で組織できない</td>

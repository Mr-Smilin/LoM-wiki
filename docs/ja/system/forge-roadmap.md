---
title: 鍛冶場・煉丹房開発ロードマップ
description: 鍛冶場・煉丹房開発ロードマップ
aside: true
outline: [2, 3]
sidebar: false
borderless: true
...
graph TB
  ...
  %% 返却矢印（緑色）+ テキスト
  B -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
  C -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| B
  D -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
  E -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
  F -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| B
  G -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
...
graph TB
  subgraph 鍛冶場 - 装備 - 防具
    A[唐門制服<img src="/LoM-wiki/images/items/equips/icon_equip_01.webp"><br>必要：なし]
  ...
  %% 返却矢印（緑色）+ テキスト
  B -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
  C -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
  D -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
  E -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
  F -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| B
...
graph TB
  subgraph 鍛冶場 - 暗器 - 罠
    A[似草針<img src="/LoM-wiki/images/items/traps/icon_trap_01.webp"><br>必要：なし]
    B[地鳴雷<img src="/LoM-wiki/images/items/traps/icon_trap_10.webp"><br>必要：装備レベル10<br>門派規模2]
    C[猛火油櫃<img src="/LoM-wiki/images/items/traps/icon_trap_11.webp"><br>必要：装備レベル10<br>門派規模2]
  end
...
graph TB
  subgraph 煉丹房 - 霊丹
    A[南蝥礜石散<img src="/LoM-wiki/images/items/medis/icon_medi_01.webp"><br>必要：なし]
    B[穿心龍膽湯<img src="/LoM-wiki/images/items/medis/icon_medi_02.webp"><br>必要：なし]
    C[乖乖水<img src="/LoM-wiki/images/items/medis/icon_medi_04.webp"><br>必要：なし]
    D[胡椒粉丸<img src="/LoM-wiki/images/items/medis/icon_medi_03.webp"><br>必要：門派規模2]
    E[睡丹<img src="/LoM-wiki/images/items/medis/icon_medi_05.webp"><br>必要：なし]
  end
  ...
  B -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
  C -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
  D -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| B
  E -.->|<font color='#00FF00'>鍛造ポイント・通貨を90%返却</font>| A
